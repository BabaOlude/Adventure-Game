...
def print_pause(message_to_print):  # initial definition
    print(message_to_print)
    time.sleep(3)


def intro():   # definining the game intro
...
def motorcycle_exit(items):  # defining the 1st way to try and escape
...
def make_haste(items):
    haste = ("1 - for the parking garage",
             "2 - for the tarmac",
             "3 - for baggage claim")
    haste1 = (random.choice(haste))
    print_pause("You're willing to try anything")
    if haste1 == '1 - for the parking garage':
        motorcycle_exit(items)
        make_choice(items)
    elif haste1 == '2 - for the tarmac':
        airplane_exit(items)
        make_choice(items)
    elif haste1 == '3 - for baggage claim':
        run_exit(items)
        make_choice(items)
    else:
...
def play_again():  # Allowing the user to play again if they would like to
